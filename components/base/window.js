...
export function WindowEditButtons(props) {
  return (
    <div className="absolute select-none right-0 top-0 mt-1 mr-1 flex justify-center items-center">
      ...
      >
        <img
          src="./themes/Sachok/window/window-minimize-symbolic.svg"
      ...
      {props.isMaximised ? (
        ...
        >
          <img
            src="./themes/Sachok/window/window-restore-symbolic.svg"
        ...
        >
          <img
            src="./themes/Sachok/window/window-maximize-symbolic.svg"
      ...
      >
        <img
          src="./themes/Sachok/window/window-close-symbolic.svg"
